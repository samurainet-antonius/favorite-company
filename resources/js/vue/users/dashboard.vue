        ...
        <div class="content">
            <div class="row ">
                <div class="col-md-12">
                    <div class="form-group">
                        <label for="company">Search Name Company</label>
                        <input type="text" class="form-control" v-model.trim="search" @keyup="showCompany()">
            ...
            <div class="row">
                <div class="col-md-12 mt-3">
                    <div class="clearfix">
                        <h3 class="sigin-text mb-3 float-left">List Company</h3>
                        <div v-if="isDisabled == true">
                                <button :disabled="isDisabled" class="btn btn-class float-right">
                                    <font-awesome-icon icon="spinner"/>
                                    Proccess
                                </button>
                        </div>
                        <div v-else>
                            <button class="btn btn-class float-right" :class="hidden == true ? 'd-none' : ''" @click="save()">Add Favourite</button>
                        </div>
                    </div>
...
export default {
    ...
    methods:{
        ...
        save(){
            ...
            axios.post('/api/user/addFavourite',{
